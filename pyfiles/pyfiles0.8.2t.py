...
def show_whats_new():
    ...
    messagebox.showinfo(
        ...
        "PyFiles v0.8.2t\n\n"
        ">> new-UI updated\n"
        ">> Choosing destination in Create mode\n"
        ">> Amount of copy to create in Create mode\n"
    )
...
title = tk.Label(menu_frame, text="PyFiles v0.8.2t                                                                                              ", font=("Segoe UI", 10))
...
center_frame.place(relx=0.5, rely=0.60, anchor="center", relwidth=1)
