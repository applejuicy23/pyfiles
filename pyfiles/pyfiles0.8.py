...
def show_whats_new():
    ...
    messagebox.showinfo(
        ...
        "PyFiles v0.8\n\n"
        ">> new-UI test started\n"
        ">> text preview in Create mode\n"
        ">> fixed bug with creating file in empty destination\n"

        "p.s here is a lot of bugs... not fixed yet\n"
        "but we are starting to make new UI\n"
        "with fixing main func bugs!\n"
    )
