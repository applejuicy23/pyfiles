...
def show_whats_new():
    ...
    text.insert("1.0",
        ...
        ">> Double file choosing is fixed\n"
        ">> Use Ctrl + Right click to delete both files from both columns Copy/Move \n"
        ">> \n"
        ">> \n"
        ">> \n"
        ">> \n"
...
files_tree.bind("<Button-1>", lambda e: clear_all_tree_selections(e, files_tree), add="+")
