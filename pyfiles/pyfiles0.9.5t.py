...
def show_whats_new():
    ...
    text.insert("1.0",
        ...
        ">> Console prototype added\n"
        ">> LOG files creating prototype added \n"
        ">> Create is working stable now\n"
        ">> !!! DELETE IS WORKING BAD\n"
        ">> Error logs updated\n"
    )
...
tk.Button(root, text="Open Console", command=open_log_console).pack()
