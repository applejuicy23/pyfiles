...
def insert_folder(tree, parent, folder_path, depth=1, max_depth=float("inf")):
...
def show_about():
    ...
    tk.Label(
        about_window,
        text="PyFiles v0.10.2\n\nNot-a-Simple GUI tool\nPython 3.14 + tkinter\nv0.10.2 - UNDER CONSTRUCTION",
        bg="#1e1e1e",
        fg="white",
        justify="center"
    ).pack(pady=10)
...
def save_log(logs, errors, action="Process"):
    ...
    with open(log_filename, "w", encoding="utf-8") as f:
        f.write("LOG\n")
        f.write("Version: PyFiles v0.10.2\n")
